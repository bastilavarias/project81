...
export default function AppSlider({ isOpen, onClose, children }: AppSliderProps) {
    ...
    return (
        <div
            className={cn(
                'bg-white h-screen z-10 fixed inset-y-0 top-0 right-0 transform shadow-2xl transition-transform duration-300 ease-in-out',
        ...
        >
            <div className="container mx-auto">
                <div className="flex justify-between py-5">
                    {
                        isExpanded ? <AppTooltip label="Minimize">
