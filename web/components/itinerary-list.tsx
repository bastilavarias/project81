    ...
    return (
        <div className="min-h-screen overflow-auto pb-16">
            <div>
                ...
                <Accordion type="multiple" className="w-full" value={['day-1', 'day-2', 'day-3']}>
                    {
                        Array.from({ length: 3 }, (_, i) => i + 1).map((n) => (
                            <AccordionItem value={`day-${n}`} className="border-b-0 my-0 hover:no-underline" key={n}>
                                <AccordionTrigger className="hover:no-underline">
                                    <div className="flex items-center space-x-3">
                                        <ChevronRight className="w-8 h-8" />
                                        <div className="flex flex-col items-start">
                                            <span className="text-lg">Day {n} Arrival & Basco Exploration</span>
                                            <span
                                                className="text-xs text-gray-500 mt-0.5">Thu, May 8 24</span>
                                        </div>
                                    </div>
                                </AccordionTrigger>
                                <AccordionContent>
                                    <div className="pl-11 space-y-3 pt-3">
                                        ...
                                        <Button variant="outline" className="rounded-full mt-8 shadow-none"
